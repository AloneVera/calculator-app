namespace Hesaplama_Programı
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("Segoe UI Semibold", 20.25F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label1.Location = new Point(192, 36);
            label1.Name = "label1";
            label1.Size = new Size(379, 37);
            label1.TabIndex = 0;
            label1.Text = " size nasıl yardımcı olabilirim?";
            // 
            // label2
            // 
